...
def main():
    ...
    if args.aug_test:
        if cfg.data.test.type == 'CityscapesDataset':
            ...
            cfg.data.test.pipeline[1].img_ratios = [0.75, 0.875, 1.0, 1.125, 1.25]
            cfg.data.test.pipeline[1].flip = True
        else:
    ...
    if args.eval_options is not None:
        # args.eval_options is a dict when provided via DictAction
        efficient_test = args.eval_options.get('efficient_test', efficient_test)
